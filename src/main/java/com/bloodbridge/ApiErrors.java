...
public class ApiErrors {
 @ExceptionHandler({org.springframework.web.servlet.resource.NoResourceFoundException.class,org.springframework.web.servlet.NoHandlerFoundException.class}) ResponseEntity<?> notFound(){return ResponseEntity.status(404).body(Map.of("error","This page or sign-in method is not supported."));}
 ...
 @ExceptionHandler(AuthenticationException.class) ResponseEntity<?> auth(){return ResponseEntity.status(401).body(Map.of("error","Please sign in again."));}

CREATE TABLE inbox_threads (
 id VARCHAR(36) PRIMARY KEY, owner_id VARCHAR(36) NOT NULL,
 source_key VARCHAR(120) NOT NULL UNIQUE, kind VARCHAR(20) NOT NULL, subject VARCHAR(180) NOT NULL,
 draft_text VARCHAR(4000) NOT NULL DEFAULT '', draft_revision INT NOT NULL DEFAULT 0,
 sent_revision INT NOT NULL DEFAULT 0, admin_unread BIT(1) NOT NULL DEFAULT b'1',
 member_unread BIT(1) NOT NULL DEFAULT b'1', created_at BIGINT NOT NULL, updated_at BIGINT NOT NULL,
 CONSTRAINT fk_inbox_owner FOREIGN KEY(owner_id) REFERENCES accounts(id)
);
...
CREATE TABLE inbox_messages (
 id VARCHAR(36) PRIMARY KEY, thread_id VARCHAR(36) NOT NULL,
 ...
 CONSTRAINT fk_inbox_message_thread FOREIGN KEY(thread_id) REFERENCES inbox_threads(id),
